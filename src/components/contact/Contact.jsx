        ...
        <section id="about" class="about">
          <div className="contact" id="contact">
            ...
            <div className="email">
              ...
              <a style={{ textDecoration: "none", color: "#18d26e" }} href="arundeva1710@gmail.com"> arundeva1710@gmail.com </a></p>
              </div>
            <div className="email">
              ...
              <a style={{ textDecoration: "none", color: "#18d26e" }} href="https://www.linkedin.com/in/arunkumaar-d"> arunkumaar-d </a></p>
              </div>
